function myscreen = DPF_ExoAttnPracticeSlow(observer,IndContrast,Eye)
...
task{1}.segmin =     [1 Inf .06 .06 .5 .04 .66 5 5];
task{1}.segmax =     [1 Inf .06 .06 .5 .04 .66 5 5];
task{1}.getResponse = [0 0 0 0 0 0 0 1 0];

n_repeats = 3; % 24 trials per block
